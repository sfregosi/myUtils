...
path_in='H:\M3R_randPeriods_downsampled\96kHz_2016\';
% cd(path);
% path_out1='H:\score\2016\q001-125\';
% mkdir(path_out1);
% path_out2='H:\score\2016\q001-10\';
% mkdir(path_out2);
path_out3='H:\M3R_randPeriods_downsampled\1kHz_2016\';
mkdir(path_out3);
...
for f=1:length(files)
    try
        ...
        audiowrite([path_out3 files(f,1).name(1:7) '01' files(f,1).name(10:end)],data2,fs2);
        fprintf(1, '.');
