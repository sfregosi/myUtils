% convert downsample to 180 kHz 10 kHz and 1 kHz + 5 kHz

% clear all
% clc
warning('off')

path='E:\SoCal2020\sg607wav\';
% cd(path);
% path_out1='E:\SoCal2020\sg607_downsampled\sg607-180kHz\';
% mkdir(path_out1);
% path_out2='E:\SoCal2020\sg607_downsampled\sg607-10kHz\';
% mkdir(path_out2);
% path_out3='E:\SoCal2020\sg607_downsampled\sg607-1kHz\';
% mkdir(path_out3);
path_out4='E:\SoCal2020\sg607_downsampled\sg607-5kHz\';
mkdir(path_out4);
...
% save('sampleRatePerFile_sg607.mat','fsTable');