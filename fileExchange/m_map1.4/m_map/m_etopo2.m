...
% Dec/29/2022 - allow to specify PATHNAME as varargin


%%% This will have to be set by YOU the USER! ---------------------

%PATHNAME='/ocean/rich/more/mmapbase/etopo2v2/';   % Be sure to end the path with a "/" or
if ~any(strcmp(varargin, 'PATHNAME'))
    PATHNAME='C:\Users\Selene.Fregosi\Documents\GIS\etopo1\';   % Be sure to end the path with a "/" or
    % whatever your separator is.
elseif any(strcmp(varargin, 'PATHNAME'))
    pnIdx = find(strcmp(varargin, 'PATHNAME'));
    PATHNAME = varargin{pnIdx+1};
    varargin(pnIdx:pnIdx+1) = [];
end
